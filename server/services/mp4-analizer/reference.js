...
var MP4Reader = (function reader() {
    ...
    constructor.prototype = {
        ...
        read: function () {
            ...
            //TODO:VIDOOLOO-- Read actual boxes!
...
var Track = (function track() {
    ...
    constructor.prototype = {
        ...
        getTotalTime: function () {
            ...
            //     this.trak.mdia.mdhd.timeScale;
            return this.trak.mdia.mdhd.duration;
        },
        getTotalTimeInSeconds: function () {
            return this.timeToSeconds(this.getTotalTime() / this.getTimeScale());
        },
        ...
        getSampleNALUnits: function (sample) {
            var bytes = this.file.stream.bytes; ////TODO:VIDOOLOO-- all the file data
            debugger;
    ...
    constructor.prototype = {
        readAll: function (callback) {
            ...
            this.stream.readAll(null, function (buffer) {
                //TODO:VIDOOLOO-- Read file data as its being recieved
        ...
        play: function () {
            ...
            //TODO:VIDOOLOO-- saparated tracks -- NO '0', it is dictionary
            var video = reader.tracks[1];
            var audio = reader.tracks[2];

            //TODO:VIDOOLOO--  Location of Decoder Configuration Record
            ...
            this.avc.decode(sps); //TODO:VIDOOLOO-- Sequence Parameter - settings for decoding
            this.avc.decode(pps); //TODO:VIDOOLOO--  Picture Parameter-- --//--
            ...
            setTimeout(function foo() {
                var avc = this.avc;
                //TODO:VIDOOLOO--  Get Frame By Frame Count ( specific frame )
                video.getSampleNALUnits(frameCount).forEach(function (nal) {
                    //TODO:VIDOOLOO-- Get Actual Frame Data == nal
                    avc.decode(nal);
                });
                frameCount++;
                if (frameCount < 3000) {
